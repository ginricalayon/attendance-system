              ...
              <DropdownMenuTrigger asChild>
                ...
                >
                  <Avatar className="h-8 w-8 rounded-lg">
                    <AvatarFallback className="rounded-lg bg-primary/10 text-primary uppercase text-xs">
                      {session?.email ? session.email.substring(0, 2) : "U"}
                    </AvatarFallback>
                  </Avatar>
                  <div className="grid flex-1 text-left text-sm leading-tight">
                    <span className="truncate font-semibold">{session?.email || "User"}</span>
